...
def nodeInitializer():
    ...
    m4MultiplierNode.m1 = mAttr1.create("matrix1", "m1", om.MFnMatrixAttribute.kDouble)
    MAKE_INPUT(mAttr1)
    m4MultiplierNode.addAttribute(m4MultiplierNode.m1)

    mAttr2 = om.MFnMatrixAttribute()
    m4MultiplierNode.m2 = mAttr2.create("matrix2", "m2", om.MFnMatrixAttribute.kDouble)
    MAKE_INPUT(mAttr2)
    m4MultiplierNode.addAttribute(m4MultiplierNode.m2)

    mAttr3 = om.MFnMatrixAttribute()
    m4MultiplierNode.mOutput = mAttr3.create("matrixOutput", "mO", om.MFnMatrixAttribute.kDouble)
    MAKE_OUTPUT(mAttr3)
